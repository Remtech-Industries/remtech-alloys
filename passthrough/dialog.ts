...
const dialog: PrimeVuePTOptions['dialog'] = {
  ...
  closeButton: {
    class: [
      ...
      'w-8 h-8 text-slate-500 bg-transparent rounded-full transition duration-200 ease-in-out mr-2 last:mr-0',
      'hover:text-slate-700 hover:border-transparent hover:bg-slate-200',
      'focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)]', // focus
    ]
  },
  closeButtonIcon: 'w-4 h-4 inline-block',
  content: 'overflow-y-auto bg-slate-50 text-slate-700 px-6 pb-8 pt-2 rounded-b-lg',
  footer: 'shrink-0 border-t-0 bg-white text-slate-700 px-6 pb-6 text-right rounded-b-lg',
